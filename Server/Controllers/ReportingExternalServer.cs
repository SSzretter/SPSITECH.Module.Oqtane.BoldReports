...
{
    public sealed class ReportingExternalServer : ReportingServer
    {
        string basePath;
        ...
        public ReportingExternalServer(IWebHostEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
            basePath = _hostingEnvironment.WebRootPath;
            basePath = Path.Combine(this.basePath, "BoldReports");
            this.reportResourcePath = Path.Combine(this.basePath, "Reports");
